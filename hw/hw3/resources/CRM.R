...
design_para$chrt_size <- 1  ## how many subjects for one group (cohort)
...
table(cur_dat$dose)  ### % of patients treated at each dose
mean(cur_dat$y)  ### % of patients who experienced DLT
cur_dat$d_star   ### chosen MTD based on all avaialble data
